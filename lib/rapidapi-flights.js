...
function mapItinerary(raw, i, { origin, destination, departureDate }) {
  ...
  return {
    ...
    departureDate: leg?.date || departureDate,
...
export async function searchFlights({
  ...
  // ROUND TRIP
  //
  // TWO INDEPENDENT ONE-WAY SEARCHES
  // ═══════════════════════════════════════════════
  ...
  const inboundJson = await fetchItineraries({
    origin: destination,
    destination: origin,
    departureDate: returnDate,
  });
